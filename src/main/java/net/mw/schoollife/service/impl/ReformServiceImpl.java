...
import net.mw.schoollife.dao.ReformDao;
import net.mw.schoollife.dao.TaskDao;
import net.mw.schoollife.pojo.po.ReformPO;
import net.mw.schoollife.pojo.vo.ReformVO;
import net.mw.schoollife.service.ReformService;
...
public class ReformServiceImpl implements ReformService {
	...
	/* (non-Javadoc)
	 * @see net.mw.schoollife.service.ReformService#getList()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.mw.schoollife.service.ReformService#getById(net.mw.schoollife.pojo.po.ReformPO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.mw.schoollife.service.ReformService#add(net.mw.schoollife.pojo.po.ReformPO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.mw.schoollife.service.ReformService#update(net.mw.schoollife.pojo.po.ReformPO)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.mw.schoollife.service.ReformService#del(net.mw.schoollife.pojo.po.ReformPO)
	 */
	@Override
